...
// Add 36 additional sensors
const additional36Sensors = `  {
...
// Find the last sensor in professionalSensors array and add after it
const insertPoint = content.lastIndexOf('    overview: {');
if (insertPoint !== -1) {
  // Find the end of that sensor object
  ...
  if (endPoint !== -1) {
    ...
    console.log('Successfully added 36 sensors!');
  }
}
